...
public class MyApplication {
    ...
    public void getAllStaffMenu(){
        String response = controller.getAllStaff();
        System.out.println(response);
    }
    public void removeStaffByNameMenu(){
        System.out.println("Please enter name");
        String name = scanner.next();
        String response = controller.deleteStaffByName(name);
        System.out.println(response);
    }
}
